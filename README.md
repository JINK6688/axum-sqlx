...
- Improve `.env.example` with recommended variables and sample values
- Rename `crates/repositroy` → `crates/repository` and update references
- Add a GitHub Actions workflow that runs migrations and tests in CI

Tell me which you'd like me to create next.