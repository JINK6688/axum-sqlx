...
## 我可以继续为你做的事情
你可以让我为你完成下面任意一项：
- 生成 `docker-compose.yml`（包含 Postgres + API）
- 自动生成或完善 `.env.example`
- 将 README 翻译成英文版（我也可以同时生成 `README.en.md`）
- 将 `crates/repositroy` 重命名为 `crates/repository` 并更新引用（请确认你希望修改源代码名）

请告诉我你想要我先做哪一个，我会继续完成。
